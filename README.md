 ...
 * Sometimes, things go wrong. When they do, it's nice to find out about application errors as soon as your users do. One simple way to get notifications when there's a server error is to install [the exception_notification gem](https://github.com/smartinez87/exception_notification).
